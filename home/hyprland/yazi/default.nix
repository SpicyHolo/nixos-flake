{pkgs, lib, config, ...}:
{
  ...
  programs.yazi = {
    ...
    settings = {
      manager = {
        ...
        keymap = [
          ...
          { on = [ "g" "g" ]; run = "arrow -99999998"; desc = "Move cursor to the top"; }
    ...
    spotters = {
      ...
      # Plugin fetchers, spotters, preloaders, and previewers configuration
      plugin.fetchers = [
      ...
      plugin.previewers = [
        ...
        { name = "*.{img,fat,ext,ext2,ext3,ext4,squashfs,ntfs,hfs,hfs; }"; run = "archive"; }
        { mime = "font/*"; run = "font"; }
        { mime = "application/ms-opentype"; run = "font"; }
